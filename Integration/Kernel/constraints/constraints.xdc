...
# create_clock -add -name sys_clk_pin -period 5.00 -waveform {0 2.50} [get_ports {clk}];
 #create_clock -add -name clk -period 10.00 -waveform {0 5.0} [get_ports {clk }];
...
##Buttons
 ...
 set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { btnN }]; #IO_L4N_T0_D05_14 Sch=btnu
 set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { btnW }]; #IO_L12P_T1_MRCC_14 Sch=btnl
 set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { btnE }]; #IO_L10N_T1_D15_14 Sch=btnr
 set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { btnS }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd
