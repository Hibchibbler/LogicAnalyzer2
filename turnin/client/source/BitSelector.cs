    ...
    public partial class BitSelector : UserControl
    {
        ...
        public byte[] RawData
        {
            get
            {
                ...
                b[0] = (byte)(int.Parse(lblBit0.Text) << 0);
                b[0] |= (byte)(int.Parse(lblBit1.Text) << 1);
                b[0] |= (byte)(int.Parse(lblBit2.Text) << 2);
                b[0] |= (byte)(int.Parse(lblBit3.Text) << 3);
                b[0] |= (byte)(int.Parse(lblBit4.Text) << 4);
                b[0] |= (byte)(int.Parse(lblBit5.Text) << 5);
                b[0] |= (byte)(int.Parse(lblBit6.Text) << 6);
                b[0] |= (byte)(int.Parse(lblBit7.Text) << 7);

                b[1] = (byte)(int.Parse(lblBit8.Text) << 0);
                b[1] |= (byte)(int.Parse(lblBit9.Text) << 1);
                b[1] |= (byte)(int.Parse(lblBit10.Text) << 2);
                b[1] |= (byte)(int.Parse(lblBit11.Text) << 3);
                b[1] |= (byte)(int.Parse(lblBit12.Text) << 4);
                b[1] |= (byte)(int.Parse(lblBit13.Text) << 5);
                b[1] |= (byte)(int.Parse(lblBit14.Text) << 6);
                b[1] |= (byte)(int.Parse(lblBit15.Text) << 7);

                b[2] = (byte)(int.Parse(lblBit16.Text) << 0);
                b[2] |= (byte)(int.Parse(lblBit17.Text) << 1);
                b[2] |= (byte)(int.Parse(lblBit18.Text) << 2);
                b[2] |= (byte)(int.Parse(lblBit19.Text) << 3);
                b[2] |= (byte)(int.Parse(lblBit20.Text) << 4);
                b[2] |= (byte)(int.Parse(lblBit21.Text) << 5);
                b[2] |= (byte)(int.Parse(lblBit22.Text) << 6);
                b[2] |= (byte)(int.Parse(lblBit23.Text) << 7);

                b[3] = (byte)(int.Parse(lblBit24.Text) << 0);
                b[3] |= (byte)(int.Parse(lblBit25.Text) << 1);
                b[3] |= (byte)(int.Parse(lblBit26.Text) << 2);
                b[3] |= (byte)(int.Parse(lblBit27.Text) << 3);
                b[3] |= (byte)(int.Parse(lblBit28.Text) << 4);
                b[3] |= (byte)(int.Parse(lblBit29.Text) << 5);
                b[3] |= (byte)(int.Parse(lblBit30.Text) << 6);
                b[3] |= (byte)(int.Parse(lblBit31.Text) << 7);
                return (b);
            }
        }
        ...
        private void BitSelector_Load(object sender, EventArgs e)
        {
